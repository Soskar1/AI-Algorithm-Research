...
// This is .NET 6 Priority Queue implementation
// Link: https://github.com/dotnet/runtime/blob/v6.0.36/src/libraries/System.Collections/src/System/Collections/Generic/PriorityQueue.cs
...
namespace AiAlgorithmsResearch.Core.Ai.Application
{
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        public PriorityQueue(int initialCapacity, IComparer<TPriority>? comparer)
        {
            if (initialCapacity < 0)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(initialCapacity), initialCapacity, "Need not negative number");
            }
        ...
        public int EnsureCapacity(int capacity)
        {
            if (capacity < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(capacity), capacity, "Need not negative number");
            }
        ...
        public sealed class UnorderedItemsCollection : IReadOnlyCollection<(TElement Element, TPriority Priority)>, ICollection
        {
            ...
            void ICollection.CopyTo(Array array, int index)
            {
                ...
                if (array.Rank != 1)
                {
                    throw new ArgumentException(nameof(array), "Multidimensional rank is not supported");
                }
